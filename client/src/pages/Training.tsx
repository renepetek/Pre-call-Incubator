/*
Design philosophy: VSL training landing page modeled after the /thankyou layout — same KST gold branding, same FAQ/case-studies/testimonials/footer sections — but with a sales-focused hero (WATCH NOW headline + offer subheadline) instead of the post-booking confirmation hero. VSL embed reuses the thankyou Vidalytics ID as a placeholder until the real training video is uploaded.
*/
